...
frmla <- ~ user_success_ratio + bots_success_ratio + bots_flip_success_ratio + jobs_success_ratio

vobj <- varclus(frmla, data = df22, trans = "abs")
vobjLabels <- c(
    "user_success_ratio", "bots_success_ratio", "bots_flip_success_ratio", "jobs_success_ratio"
)
...
frmla <- label~user_success_ratio + bots_success_ratio + bots_flip_success_ratio + jobs_success_ratio
objLabels <- c(
...
# ========= Fit model ========#
frmla <- label~ rcs(user_success_ratio, 3) + rcs(bots_success_ratio, 3) + rcs(bots_flip_success_ratio, 3) + jobs_success_ratio
print(frmla)
